  ...
  return (
    <div className='mx-30 my-20 ' >
        <div className='text-center text-dark-text  mb-15'>
          ...
          <p className='justify-center text-xs font-normal text-black-text/80'>Ornare id fames interdum porttitor nulla turpis etiam. Diam vitae sollicitudin at nec <br /> 
        ...
        <div key={index}>
          ...
          <p className="mt-2 text-lg font-medium text-black-text/80">
            {item.description}
          </p>
        </div>
      ))}
