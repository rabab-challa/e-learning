...
const OurFeatures = () => {
  return (
    <div className="my-10 ">
      <h1 className="lg:text-2xl text-center text-lg text-blue-dark font-bold">
        Our <span className="text-blue-cyan">Features</span>
      </h1>
      <br />
      <p className="text-base text-grey-text font-normal text-center ">
      ...
      <div className="px-30 relative pt-30 pb-10 flex gap-40">
              ...
              <div className="relative  w-45 h-45 overflow-hidden rounded-lg shadow-xl/30">
                ...
                >
                  ...
                  <p className=" flex items-center">
                    {" "}
                    <span className=" bg-blue-light py-0.5 px-1 rounded-sm">
                      Instructor
                    </span>{" "}
                    Eveny Howard
                  </p>
             ...
             font-normal"
              ...
              <div className="bg-pink-light1 p-1.5 rounded-full inline-block">
                <button
                  ...
                  font-medium "
                >
                  <Image src="/call.png" alt="Call" width={15} height={15} />
                  <span>Call</span>
                </button>
              </div>
            </div>
        ...
        <div className="leading-loose mt-10">
          <h3 className="text-blue-dark font-semibold leading-normal w-110 text-3xl">
            A<span className="text-blue-cyan"> user interface</span> designed{" "}
            <br />
            for the classroom
          </h3>
          <br />
      ...
      <div className="px-40 py-20 flex justify-between">
        <div className="flex-cols pt-40 mr-20">
          <h2 className="text-blue-dark leading-normal text-3xl font-semibold">
            <span className="text-blue-cyan"> Tools</span> For Teachers
            <br /> And Learners{" "}
          </h2>
          <br />
          <p className="text-grey-text text-base w-100 leading-7 text-justify">
      ...
      <div className="px-40 py-10 flex justify-between">
        <div className="relative">
          ...
          <div className="relative  bg-white rounded-xl shadow-[0_-4px_30px_rgba(0,0,0,0.06)] p-6 w-85 h-100">
            ...
            <div className="absolute -top-8 -right-4">
              <Image src="/cross.png" alt="cross" width={120} height={120} />
            </div>
        ...
        <div className="mt-20 ">
          <h3 className="text-3xl text-blue-dark font-semibold leading-normal ">
            Assessments, <br />
            <span className="text-blue-cyan">Quizzes</span>, Tests
          </h3>
          <br />
          <p className="text-base text-grey-text font-normal leading-loose">
      ...
      <div className="pl-30 pr-50 py-30 flex gap-20 justify-between">
        <div className="mt-20">
          <h3 className="text-2xl text-blue-cyan font-semibold leading-normal ">
            Class Management
            <br />
            <span className="text-blue-dark">Tools for Educators</span>
          </h3>
          <br />
          <p className="text-base text-grey-text font-normal leading-loose w-110">
...
=======
>>>>>>> 27eb18daf1af5f1e3c63faa64ca3a5cd626bf239

        {/* Wrapper */}
        <div className="relative">
          {/* Background Box Behind Card */}
          <div className="absolute -bottom-7 -left-7 w-42 h-34 bg-blue-sky4 rounded-xl"></div>

          {/* Main Card */}
          <div className="relative z-10 w-120 h-85 overflow-visible bg-white rounded-2xl shadow-lg">
...
=======
            ...
            <div className="absolute -top-5 -left-3 w-18 h-18 bg-white/60 rounded-full shadow-md flex items-center justify-center">
              <div className="w-13 h-13 bg-white rounded-full shadow-md flex items-center justify-center">
                <Image src="/star.png" alt="star" width={44} height={44} />
              </div>
            </div>

            <div className="absolute top-4 -right-8 w-14 h-14 bg-white/30 rounded-full shadow-lg flex items-center justify-center">
              <div className="w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center">
                <Image src="/book 1.png" alt="book" width={24} height={24} />
              </div>
            </div>
              ...
              {gradebookData.map((item) => (
                ...
                >
                  {item.align === "left" ? (
                    <>
                      <div
                        className={`${item.lineWidth} h-5 ${item.lineBg}`}
                      ></div>
                      ...
                      <div
                        className={`${item.scoreBg} ${item.scoreText} px-4 py-1 rounded-full`}
                      >
                        {item.score}
                      </div>
                    </>
...
>>>>>>> 27eb18daf1af5f1e3c63faa64ca3a5cd626bf239
      ...
      <div className="pl-30 pr-40 py-20 flex justify-between gap-60">
        <div className="relative z-0">
          ...
          />
          <Image src="/blurBg.png" alt="blurbg" width={480} height={40} />
          <div className="absolute top-18  left-18">
            ...
            <div className="relative w-110 backdrop-blur-sm rounded-b-xl shadow-xl shadow-b-xl h-65 z-10 bg-white">
              ...
              <div className="absolute bottom-3 left-10">
                ...
                <p className="text-grey-light4 text-xs font-light">
                  Your video can't be seen by others
                </p>
              </div>
              <div className="absolute bottom-3 right-5 ">
                <button className="bg-gradient-to-r from-red-start to-red-end rounded-full w-35 shadow-xl/30 shadow-[#EB493A] text-white text-base h-10">
                  End Discussion
                </button>
              </div>
            </div>
            <div className="absolute top-8 -left-8 w-18 h-18 z-10 bg-white/60 rounded-full shadow-md flex items-center justify-center">
              <div className="w-13 h-13 bg-white rounded-full shadow-md flex items-center justify-center">
                <Image src="/vector.png" alt="user" height={40} width={40} />
              </div>
            </div>
          </div>
        ...
        <div className="mt-20">
          <h2 className="text-blue-dark text-3xl font-semibold w-90 leading-normal">
            One-on-One <span className="text-blue-cyan">Discussions</span>
          </h2>
          <p className="text-grey-text text-sm font-normal leading-loose w-90">
      ...
      <div className="flex justify-center mt-30">
        <button className="text-blue-cyan2 border border-blue-cyan2 rounded-full w-50 h-15">
          {" "}
          See more features
        </button>
      </div>
